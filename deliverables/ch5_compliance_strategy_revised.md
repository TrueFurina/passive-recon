...
12. Human-in-the-Loop (AI Security Wiki) — https://snailsploit.com/ai-security/wiki/defenses/human-in-the-loop
13. OSINT and AI: A Regional Look (CELE) — https://observatoriolegislativocele.com/en/osint-e-inteligencia-artificial-una-mirada-regional-sobre-una-combinacion-explosiva-por-nicolas-zara/
14. Mastering API Rate Limiting — https://apipark.com/techblog/en/mastering-how-to-circumvent-api-rate-limiting-effectively/
15. LangGraph Checkpointers — https://callsphere.ai/blog/langgraph-checkpointer-durable-resumable-agents
16. Trigger.dev: Durable Agent Execution — https://www.zenml.io/llmops-database/durable-agent-execution-through-snapshot-and-restore-infrastructure
17. Agent长流程断点续跑 — https://blog.csdn.net/2501_91483426/article/details/161495080
18. LangGraph检查点机制深度解析 — https://devpress.csdn.net/v1/article/detail/155517593
19. CTF实战冲榜 — https://cn-sec.com/archives/4839805.html
20. NIST AI Risk Management Framework (AI RMF 1.0) — https://www.nist.gov/itl/ai-risk-management-framework
21. Microsoft Learn: 开源软件实现与治理 — https://learn.microsoft.com/zh-cn/training/modules/implement-open-source-software-azure/9-summary
22. SCA落地实践：软件成分分析与SBOM管理 — https://www.toutiao.com/article/7587665984157139519/
23. NIST AI RMF 1.0 完整文档 (PDF) — https://nvlpubs.nist.gov/nistpubs/ai/nist.ai.100-1.pdf

> 状态：修订稿（Phase 3.3 完成），待复审
